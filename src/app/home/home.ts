...
export class Home {
  ...
  latestActivity = [
  { text: 'Edited About Us page', user: 'Galvez', time: '2h ago', icon: 'assets/icons/edit.svg' },
  { text: 'Created new post', user: 'James', time: '5h ago', icon: 'assets/icons/add.svg' },
  { text: 'Deleted banner', user: 'Admin', time: '1d ago', icon: 'assets/icons/delete.svg' },
];
}
